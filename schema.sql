...
CREATE INDEX IF NOT EXISTS idx_employees_reporting_manager ON employees(reporting_manager_id) WHERE is_active = TRUE;
CREATE INDEX IF NOT EXISTS idx_employees_email ON employees(email);
CREATE INDEX IF NOT EXISTS idx_employees_active ON employees(is_active);

-- Trigger for employees
CREATE OR REPLACE TRIGGER trigger_update_employees_timestamp
...
CREATE INDEX IF NOT EXISTS idx_client_master_code ON client_master(client_code);
CREATE INDEX IF NOT EXISTS idx_client_master_active ON client_master(is_active);
CREATE INDEX IF NOT EXISTS idx_client_master_name ON client_master(client_name);

-- Trigger for client_master
CREATE OR REPLACE TRIGGER trigger_update_client_master_timestamp
...
CREATE INDEX IF NOT EXISTS idx_project_master_client ON project_master(client_id) WHERE is_active = TRUE;
CREATE INDEX IF NOT EXISTS idx_project_master_status ON project_master(status) WHERE is_active = TRUE;
CREATE INDEX IF NOT EXISTS idx_project_master_dates ON project_master(start_date, end_date);
CREATE INDEX IF NOT EXISTS idx_project_master_active ON project_master(is_active);

-- Trigger for project_master
CREATE OR REPLACE TRIGGER trigger_update_project_master_timestamp
...
CREATE INDEX IF NOT EXISTS idx_activity_master_project ON activity_master(project_id) WHERE is_active = TRUE;
CREATE INDEX IF NOT EXISTS idx_activity_master_creator ON activity_master(created_by);
CREATE INDEX IF NOT EXISTS idx_activity_master_status ON activity_master(status) WHERE is_active = TRUE;
CREATE INDEX IF NOT EXISTS idx_activity_master_dates ON activity_master(start_dt, end_dt);
CREATE INDEX IF NOT EXISTS idx_activity_master_active ON activity_master(is_active);

-- Trigger for activity_master
CREATE OR REPLACE TRIGGER trigger_update_activity_master_timestamp
...
CREATE INDEX IF NOT EXISTS idx_project_assignments_manager ON project_assignments(manager_id) WHERE is_active = TRUE;
CREATE INDEX IF NOT EXISTS idx_project_assignments_project ON project_assignments(project_id) WHERE is_active = TRUE;
...
-- =================================================================
CREATE TABLE IF NOT EXISTS activity_manager_scope (
    id UUID PRIMARY KEY DEFAULT gen_random_uuid(),
...
CREATE INDEX IF NOT EXISTS idx_activity_manager_scope_activity ON activity_manager_scope(activity_id) WHERE is_active = TRUE;
CREATE INDEX IF NOT EXISTS idx_activity_manager_scope_manager ON activity_manager_scope(manager_id) WHERE is_active = TRUE;
CREATE INDEX IF NOT EXISTS idx_activity_manager_scope_project ON activity_manager_scope(project_id) WHERE is_active = TRUE;
CREATE INDEX IF NOT EXISTS idx_activity_manager_scope_composite ON activity_manager_scope(manager_id, activity_id) WHERE is_active = TRUE;
...
CREATE INDEX IF NOT EXISTS idx_activity_assignments_employee ON activity_assignments(employee_id) WHERE is_active = TRUE;
CREATE INDEX IF NOT EXISTS idx_activity_assignments_activity ON activity_assignments(activity_id) WHERE is_active = TRUE;
CREATE INDEX IF NOT EXISTS idx_activity_assignments_project ON activity_assignments(project_id) WHERE is_active = TRUE;
CREATE INDEX IF NOT EXISTS idx_activity_assignments_assigned_by ON activity_assignments(assigned_by);
...
-- =================================================================
CREATE OR REPLACE TRIGGER trigger_update_project_assignments_timestamp
BEFORE UPDATE ON project_assignments
FOR EACH ROW
EXECUTE FUNCTION update_updated_at_column();

CREATE OR REPLACE TRIGGER trigger_update_activity_manager_scope_timestamp
BEFORE UPDATE ON activity_manager_scope
FOR EACH ROW
EXECUTE FUNCTION update_updated_at_column();

CREATE OR REPLACE TRIGGER trigger_update_activity_assignments_timestamp
...
CREATE INDEX IF NOT EXISTS idx_timesheet_entry_employee 
ON timesheet_entry(employee_id) 
WHERE is_deleted = FALSE;

CREATE INDEX IF NOT EXISTS idx_timesheet_entry_date 
ON timesheet_entry(entry_date) 
WHERE is_deleted = FALSE;

CREATE INDEX IF NOT EXISTS idx_timesheet_entry_week 
ON timesheet_entry(employee_id, week_start_date, week_end_date) 
WHERE is_deleted = FALSE;

CREATE INDEX IF NOT EXISTS idx_timesheet_entry_status 
ON timesheet_entry(status) 
WHERE is_deleted = FALSE;

-- Index for history/deleted queries
CREATE INDEX IF NOT EXISTS idx_timesheet_entry_deleted 
ON timesheet_entry(is_deleted);

CREATE INDEX IF NOT EXISTS idx_timesheet_entry_archived 
ON timesheet_entry(is_archived);

-- Index for manager queries
CREATE INDEX IF NOT EXISTS idx_timesheet_entry_manager 
ON timesheet_entry(manager_id, status) 
WHERE is_deleted = FALSE;

-- Index for project/activity filtering
CREATE INDEX IF NOT EXISTS idx_timesheet_entry_project 
ON timesheet_entry(project_id) 
WHERE is_deleted = FALSE;

CREATE INDEX IF NOT EXISTS idx_timesheet_entry_activity 
...
-- CREATE INDEXES
-- =================================================================
CREATE INDEX IF NOT EXISTS idx_employee_policy_employee ON employee_policy(employee_id) WHERE is_active = TRUE;
CREATE INDEX IF NOT EXISTS idx_employee_policy_active ON employee_policy(is_active);


-- =================================================================
-- ATTACH TRIGGER FOR AUTO-UPDATE TIMESTAMP
-- =================================================================
CREATE OR REPLACE TRIGGER trigger_update_employee_policy_timestamp
